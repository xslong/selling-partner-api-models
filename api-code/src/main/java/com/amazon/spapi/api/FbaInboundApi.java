...
public class FbaInboundApi {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getLabelsAsync(String shipmentId, String pageType, String labelType, Integer numberOfPackages, List<String> packageLabelsToPrint, Integer numberOfPallets, Integer pageSize, Integer pageStartIndex, final ApiCallback<GetLabelsResponse> callback) throws ApiException {
    ...
    public static class Builder {
	   ...
	   public Builder disableAccessTokenCache() {
        ...
        public FbaInboundApi build() {
            ...
            return new FbaInboundApi(new ApiClient(httpClient)
