...
public class FeedsApi {
     ...
     */
    public okhttp3.Call cancelFeedAsync(String feedId, final ApiCallback<Void> callback) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getFeedAsync(String feedId, final ApiCallback<Feed> callback) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getFeedDocumentAsync(String feedDocumentId, final ApiCallback<FeedDocument> callback) throws ApiException {
    ...
    public static class Builder {
	   ...
	   public Builder disableAccessTokenCache() {
        ...
        public FeedsApi build() {
            ...
            return new FeedsApi(new ApiClient(httpClient)
